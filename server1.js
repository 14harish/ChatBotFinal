...
manage.addDocument('en','Tell about cse','Next.cseDept');
manage.addDocument('en','About cse deparment','Next.cseDept');
manage.addDocument('en','tell or about Computer science and Engineering','Next.cseDept');


//Answers---------------------------------------------------------------------------------
// manage.addAnswer('en','Next.staff',"Hod name:Dr.A.Rajiv Kannan"); 
