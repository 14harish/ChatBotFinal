...
<nav class="bg-white border-gray-200 dark:bg-transparent fixed w-full top-0 z-50">
  ...
  <div class="hidden md:flex items-center justify-between w-full md:w-auto md:order-1 text-xl" id="navbar-user" >
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-20 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-transparent md:dark:bg-transparent dark:border-gray-700">
      <li>
